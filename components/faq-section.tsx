...
const faqData: FAQItem[] = [
  {
    question: "What is Rizgeo and who is it for?",
    answer:
      "Rizgeo is a comprehensive billing automation platform designed for businesses that need custom contract management. It's perfect for SaaS companies, service providers, and enterprises looking to streamline their billing processes.",
  },
  {
  ...
  {
    question: "Can I integrate Rizgeo with my existing tools?",
    answer:
      "Yes! Rizgeo integrates seamlessly with popular CRM systems, accounting software, and payment processors. We support APIs and webhooks for custom integrations with your existing workflow.",
  },
  {
  ...
  {
    question: "Is my data secure with Rizgeo?",
    answer:
  ...
  {
    question: "How do I get started with Rizgeo?",
    answer:
